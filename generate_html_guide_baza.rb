...
module PechnikEngineeringHub
  def self.generate_html_guide
	...
	notes[35]  = "Далее выкладывается дымоходод согласно проекту до 54 ряда. Возможны корректировки высот."
    ...
    UI.messagebox("Версия альбома стандартная\n\nДополнительные сведения-База")
  end
end
