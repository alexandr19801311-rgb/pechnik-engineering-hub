...
module PechnikEngineeringHub
  def self.generate_html_guide
	...
	notes[5]  = "При перекрытии поддувала оставить зазор в 20 мм. Это дополнительный воздушный барьер от копати на стекле дверцы."
	...
	notes[7]  = " "
	notes[8]  = "Вертикальный шамотный кирпич в топке пилим по 214 мм. Выставляем уголки для перекрытия мангала."
	notes[9]  = "Выставляем заранее собранную перемычку на шпильке м10. В топке печи тепловой зазор 5-10 мм базальта, между шамотным и прилегающими кирпичами."
	notes[10]  = "Дымоход d-120 мм нержавейка толщина 1 мм. Собирать на жаростойкий герметик. Примыкание к шамотному кирпичу проложить базальтовым картоном."
	...
	notes[21]  = "Устанавливаютя заранее собранные перемычки на шпильке м10 из лицевого и шамотного кирпича. На задней стенке топки мангала сформировался наклон 42°."
	...
	notes[25]  = "Формируется полка в виде выступа по 20 мм с 3х сторон. На шамотном ряду передние кирпичи формируют наклон 42°. "
	notes[26]  = "Сформировалась полка выступ по 20 мм с 3х сторон. Шамотный ряд весь выставлен из цельных кирпичей. Может потребоваться подрезка для свободного хода поворотных шиберов ЗВП-2. "
	notes[27]  = "На лицевом ряде подрезается 2 кирпича под оси шиберов. Этот ряд шамотного состоит из 2х. Они расширяются подрезаются под свободную посадку 2х совмещенных поворотных шибера ЗВП-2. Для более компактного размещения всей сборки шиберов 2 рамки обрамления нужно подрезать. Периметр рамки обрамления шиберов проложить базальтовым картоном."
	notes[28]  = "Финальная настройка и проверка работы поворотных шиберов."
	notes[29]  = "Примыкание выхода дымохода проложить базальтовым картоном."
	notes[30]  = "На забутовочном ряду с двух сторон боковые кирпичи свормировали переход 42° под основное сечение дымохода."
	notes[32]  = "Далее выкладывается дымоходод согласно проекту до 54 ряда. Возможны корректировки высот."
